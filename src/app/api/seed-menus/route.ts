...
const baseItems = {
    "Khai vị": [
        ...
        { name: "Súp Nấm Truffle Đen", price: 250000, img: "https://images.unsplash.com/photo-1548943487-a2e4b43b4850?w=600", desc: "Nấm truffle thượng hạng nấu chảy cùng kem nấm rơm béo ngậy.", tags: ["Thanh đạm", "Signature"], kidsFriendly: false, seafood: false, onionFree: false, status: "Chef Pick" },
        ...
        { name: "Gỏi Xoài Xanh Tai Heo", price: 125000, img: "https://images.unsplash.com/photo-1626074353765-517a681e40be?w=600", desc: "Giòn sần sật với tai heo ngâm mắm mặn ngọt chua cay.", tags: ["Cay nhẹ", "Nhậu"], kidsFriendly: false, seafood: false, onionFree: false, status: "Best Seller" },
        ...
        { name: "Gỏi Ngó Sen Tôm Thịt", price: 140000, img: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=600", desc: "Thanh mát, giòn ngọt ngó sen tôm thịt chua ngọt.", tags: ["Khai vị"], kidsFriendly: false, seafood: true, onionFree: false, status: "" },
    ],
    "Món chính": [
        ...
        { name: "Thăn Lõi Bò Mỹ Nướng (Striploin)", price: 650000, img: "https://images.unsplash.com/photo-1558030006-450675394119?w=600", desc: "Thăn bò Mỹ mềm nọng nước, nướng mọi kèm sốt tiêu đen.", tags: ["Signature", "High-end"], kidsFriendly: false, seafood: false, onionFree: false, status: "Chef Pick" },
        ...
        { name: "Bồ Câu Quay Mật Ong", price: 250000, img: "https://images.unsplash.com/photo-1560002138-04bb77cbca90?w=600", desc: "Bồ câu quay giòn da đậm vị mật ong ăn kèm bánh bao chiên.", tags: ["Signature", "Đặc sản"], kidsFriendly: true, seafood: false, onionFree: false, status: "" },
        { name: "Vịt Quay Bắc Kinh (Nửa con)", price: 450000, img: "https://images.unsplash.com/photo-1555507036-ab1f40ce88cb?w=600", desc: "Vịt quay da giòn rụm cuốn bánh đa và hành ngò, sốt hoisin.", tags: ["Nhóm 2", "Bán chạy"], kidsFriendly: true, seafood: false, onionFree: false, status: "Trending" },
        { name: "Đậu Nành Nhật Xóc Muối Hồ", price: 120000, img: "https://images.unsplash.com/photo-1585238342024-78d387f3a707?w=600", desc: "Ghiền đậu nành luộc Nhật xốt đậm. Ăn chay ngon.", tags: ["Ăn chay", "Khai vị"], kidsFriendly: true, seafood: false, onionFree: true, status: "Vegan" },
    ],
    "Hải Sản": [
        { name: "Tôm Hùm Bỏ Lò Phô Mai (500g)", price: 850000, img: "https://images.unsplash.com/photo-1629731631525-45210aa39ff6?w=600", desc: "Tôm hùm baby xẻ đôi đút lò cùng phô mai Pháp.", tags: ["Hải sản", "High-end", "Bán chạy"], kidsFriendly: true, seafood: true, onionFree: true, status: "Best Seller" },
        ...
        { name: "Mực Ống Nướng Sa Tế", price: 220000, img: "https://images.unsplash.com/photo-1599084924170-ebbcd9dfbaf1?w=600", desc: "Mực ống Phú Quốc nướng mọi cay cay cùng sa tế tôm.", tags: ["Cay", "Nhậu", "Bán chạy"], kidsFriendly: false, seafood: true, onionFree: false, status: "Trending" },
        ...
        { name: "Sò Điệp Nướng Mỡ Hành (Phần)", price: 180000, img: "https://images.unsplash.com/photo-1544249114-1fbc8bfa8d66?w=600", desc: "Sò điệp cồi lớn mềm nướng thơm cùng đậu phộng mỡ hành.", tags: ["Hải sản", "Khuyên dùng"], kidsFriendly: true, seafood: true, onionFree: false, status: "" },
    ...
    "Lẩu & Nướng": [
        ...
        { name: "Lẩu Nấm Chay Dưỡng Sinh", price: 350000, img: "https://images.unsplash.com/photo-1551624640-1bc7fb0fbd61?w=600", desc: "Hơn 10 loại nấm quý và thảo mộc ninh ngọt tự nhiên.", tags: ["Ăn chay", "Healthy", "Thanh đạm"], kidsFriendly: true, seafood: false, onionFree: false, status: "Vegan" },
        ...
        { name: "Ba Chỉ Bò Cuộn Nấm Kim Châm Nướng", price: 160000, img: "https://images.unsplash.com/photo-1555507036-ab1f40ce88cb?w=600", desc: "Ba chỉ béo mềm cuộn nấm kim châm ngọt nước, ăn cực cuốn.", tags: ["Ăn kèm nướng", "Bán chạy"], kidsFriendly: true, seafood: false, onionFree: true, status: "" },
        { name: "Bò Tơ Củ Chi Nướng Tảng", price: 340000, img: "https://images.unsplash.com/photo-1558030006-450675394119?w=600", desc: "Thịt bò tơ da xèo xèo trên than hồng mềm ngọt chấm chao tôm.", tags: ["Nhậu", "Đặc sản"], kidsFriendly: false, seafood: false, onionFree: false, status: "New" },
    ...
    "Món ăn kèm": [
        { name: "Cơm Phô Mai Bỏ Lò Trứng Cá Hồi", price: 165000, img: "https://images.unsplash.com/photo-1553882809-a4f57e59501d?w=600", desc: "Hạt cơm giòn tan phủ phô mai mozzarela béo ngậy trộn trứng cá.", tags: ["Ăn kèm", "Món no", "Trẻ em"], kidsFriendly: true, seafood: true, onionFree: true, status: "Trending" },
        ...
        { name: "Cơm Trắng Nồi Đất", price: 35000, img: "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=600", desc: "Cơm dẻo nấu từ gạo ST25 loại 1 ngon hàng đầu thế giới ngay trong niêu đất.", tags: ["Cơm", "Ăn kém"], kidsFriendly: true, seafood: false, onionFree: true, status: "" },
        { name: "Khoai Tây Lắc Phô Mai Trái Tim", price: 85000, img: "https://images.unsplash.com/photo-1584347585098-b64dccbf28d6?w=600", desc: "Khoai chuối cắt hình trái tim lắc phô mai Cheddar cực dính.", tags: ["Ăn chơi", "Trẻ em"], kidsFriendly: true, seafood: false, onionFree: true, status: "Kids" },
        { name: "Bánh Mì Bơ Tỏi", price: 45000, img: "https://images.unsplash.com/photo-1573140247632-f8fd74997d5c?w=600", desc: "Lát baguette nướng giòn với bơ xịn và tỏi băm thơm phức.", tags: ["Ăn kèm", "Bán chạy"], kidsFriendly: true, seafood: false, onionFree: false, status: "Best Seller" },
        { name: "Đậu Bắp Luộc Quẹt Chảo", price: 55000, img: "https://images.unsplash.com/photo-1461353530619-35a0ce5cd12e?w=600", desc: "Đậu bắp luộc sơ chấm cùng tương chao hoặc kho quẹt mặn.", tags: ["Ăn chay", "Thanh đạm"], kidsFriendly: true, seafood: false, onionFree: false, status: "" },
        ...
        { name: "Mì Trứng Xào Hành Baro", price: 95000, img: "https://images.unsplash.com/photo-1589302168068-964664d93cb0?w=600", desc: "Sợi mì dai trứng vàng tươi phi hành baro ăn kèm cực hợp.", tags: ["Món no"], kidsFriendly: true, seafood: false, onionFree: false, status: "" },
        { name: "Nấm Đùi Gà Nướng Bơ", price: 110000, img: "https://images.unsplash.com/photo-1548943487-a2e4b43b4850?w=600", desc: "Nấm đùi gà khổng lồ nạc nướng bơ tỏi ngọt lịm như thịt.", tags: ["Healthy", "Ăn chay", "Đặc sắc"], kidsFriendly: true, seafood: false, onionFree: false, status: "Vegan" },
        { name: "Kimchi Cải Thảo Hàn Quốc", price: 40000, img: "https://images.unsplash.com/photo-1585238342024-78d387f3a707?w=600", desc: "Nhà hàng tự muối, chuẩn độ lên men không hóa chất.", tags: ["Cay", "Ăn kèm"], kidsFriendly: false, seafood: false, onionFree: false, status: "Sides" }
    ],
    "Đồ uống": [
        { name: "Trà Đào Cam Sả Tươi", price: 65000, img: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=600", desc: "Giải khát mạnh mẽ, the mát thảo mộc và ngọt đào.", tags: ["Giải khát", "Bán chạy", "Trẻ em"], kidsFriendly: true, seafood: false, onionFree: true, status: "Refresh" },
        { name: "Nước Ép Dưa Hấu Organic", price: 75000, img: "https://images.unsplash.com/photo-1589853903178-554190dcfc3f?w=600", desc: "Lọc cặn hoàn toàn nguyên chất 100% không đường.", tags: ["Healthy", "Ít đường", "Trẻ em"], kidsFriendly: true, seafood: false, onionFree: true, status: "Healthy" },
        { name: "Bia Tươi Hefeweizen Thủ Công", price: 95000, img: "https://images.unsplash.com/photo-1566812803875-c93d4a469fb5?w=600", desc: "Hương vị lúa mì nhẹ nhàng, men nổi vị chuối trái cây.", tags: ["Cồn", "Craft Beer", "Nhậu"], kidsFriendly: false, seafood: false, onionFree: true, status: "Craft" },
        { name: "Cocktail Sunset Margarita", price: 155000, img: "https://images.unsplash.com/photo-1536935338773-84f5539d0d5b?w=600", desc: "Tequila kết hợp cam chanh, cực chill cho tiệc tối hẹn hò.", tags: ["Cồn", "Hẹn hò", "Signature"], kidsFriendly: false, seafood: false, onionFree: true, status: "Signature" },
        ...
        { name: "Moet & Chandon Imperial Brut (Chai)", price: 2500000, img: "https://images.unsplash.com/photo-1555507036-ab1f40ce88cb?w=600", desc: "Champagne trứ danh hoàn hảo cho lễ kỷ niệm.", tags: ["Cao cấp", "Tiệc"], kidsFriendly: false, seafood: false, onionFree: true, status: "Premium" },
        ...
        { name: "Bia Heineken Xanh Cà Đã Lạnh", price: 45000, img: "https://images.unsplash.com/photo-1566812803875-c93d4a469fb5?w=600", desc: "Chuẩn bia công nghiệp làm lạnh ở 2 độ C luôn the mát.", tags: ["Cồn", "Nhậu phổ thông"], kidsFriendly: false, seafood: false, onionFree: true, status: "" },
        ...
        { name: "Vang Trắng Sauvignon Blanc (Ly)", price: 180000, img: "https://images.unsplash.com/photo-1555507036-ab1f40ce88cb?w=600", desc: "Chua thanh và mùi trái nhiệt đới tuyệt hảo đi kèm Hải Sản.", tags: ["Hải sản pairing", "Cao cấp"], kidsFriendly: false, seafood: false, onionFree: true, status: "Pairing" },
    ],
    "Tráng miệng": [
        ...
        { name: "Kem Gelato Vani Orea Trân Châu", price: 95000, img: "https://images.unsplash.com/photo-1563805042-7684c8a9e9cb?w=600", desc: "Kem ý dẻo mịn tự làm mỗi ngày, ít đường không mập.", tags: ["Kem", "Trẻ em"], kidsFriendly: true, seafood: false, onionFree: true, status: "Kids Choice" },
        { name: "Bánh Tiramisu Truyền Thống", price: 120000, img: "https://images.unsplash.com/photo-1571115177098-24ecfa463124?w=600", desc: "Cà phê, rượu nồng nàn cùng mascarpone xốp mịn màng.", tags: ["Cake", "Hẹn hò", "Signature"], kidsFriendly: false, seafood: false, onionFree: true, status: "Signature" },
